#Question #1
#Create a function called rand_graph(p, n) that returns a new random graph with n nodes numbered 0 to n−1 such that every different pair of nodes is connected with probability p. Assume n>1, and 0≤p≤1
#For example:
